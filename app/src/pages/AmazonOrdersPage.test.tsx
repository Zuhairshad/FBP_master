...
describe('AmazonOrdersPage', () => {
  it('lists synced orders with their resolution status, filtered to the amazon platform', async () => {
    const orders: PlatformOrder[] = [
      ...
      },
      {
        ...
        brand_id: 'brand-1',
        platform: 'amazon',
        platform_order_id: '222-2222222-2222222',
        raw_data: { AmazonOrderId: '222-2222222-2222222' },
